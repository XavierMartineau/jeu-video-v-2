...
func create_theme_decorations() -> void:
	...
	if level_number == 1:
		...
		[Rect2(360, 500, 360, 100), Color("#b15b5b")], [Rect2(470, 500, 300, 100), Color("#b15b5b")], [Rect2(890, 500, 250, 100), Color("#b15b5b")], [Rect2(1260, 500, 260, 100), Color("#b15b5b")], [Rect2(1640, 450, 260, 28), Color("#b15b5b")], [Rect2(1990, 500, 500, 28), Color("#b15b5b")]],
